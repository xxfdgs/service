...
# @register_network('GPSDoubleModel_l1_ntx_v31')
class GPSModel(torch.nn.Module):
    ...
    def __init__(self, dim_in, dim_out):
        ...
        self.num_properties = 6  # 新增：定义预测的性质数量

        # 修改1：全连接层输入维度不变（5个组分 × hidden_dim），输出适配6个性质
