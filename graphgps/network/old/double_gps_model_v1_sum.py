...
class GPSModel(torch.nn.Module):
    ...
    def __init__(self, dim_in, dim_out):
        ...
        #### sum verision
        list_FC_layers = [nn.Linear(((cfg.gt.dim_hidden) + 1), 256, bias=True), nn.Linear(256, 512, bias=True),
                         nn.Linear(512, dim_out, bias=True)]
    ...
    def forward(self, data1, data2):
        ...
        # graph_emb = torch.cat((graph_emb_1, graph_emb_2), dim=1) ##torch.cat version
        graph_emb = graph_emb_1 + graph_emb_2  ##torch.cat version
        ### add mnw  ratio
