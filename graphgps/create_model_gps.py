"""
@Name:  create_model_gps.py
@Auth:  rongxing
@Date:  2023/6/14-下午2:15
@IDE:   PyCharm 
...
def create_model_gps(to_device=True, dim_in=None, dim_out=None) -> GraphGymModule:
    ...
    if to_device:
        model.to(torch.device(cfg.accelerator, cfg.gpu_serial))
