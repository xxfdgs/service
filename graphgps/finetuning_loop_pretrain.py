...
def load_loop_pretrained_model_cfg(cfg):
...
def init_model_from_loop_pretrained(model, pretrained_dir, run_id,
    ...
    if run_id == 0:
        ...
        ckpt_file = get_final_pretrained_ckpt(osp.join(pretrained_dir, '1', 'ckpt'))
    elif run_id == 2:
        ckpt_file = get_final_pretrained_ckpt(osp.join(pretrained_dir, '2', 'ckpt'))
    elif run_id == 3:
        ckpt_file = get_final_pretrained_ckpt(osp.join(pretrained_dir, '3', 'ckpt'))
    elif run_id == 4:
        ckpt_file = get_final_pretrained_ckpt(osp.join(pretrained_dir, '4', 'ckpt'))
    elif run_id == 5:
        ckpt_file = get_final_pretrained_ckpt(osp.join(pretrained_dir, '5', 'ckpt'))
    elif run_id == 6:
        ckpt_file = get_final_pretrained_ckpt(osp.join(pretrained_dir, '6', 'ckpt'))
    elif run_id == 7:
        ckpt_file = get_final_pretrained_ckpt(osp.join(pretrained_dir, '7', 'ckpt'))
    elif run_id == 8:
        ckpt_file = get_final_pretrained_ckpt(osp.join(pretrained_dir, '8', 'ckpt'))
    elif run_id == 9:
        ckpt_file = get_final_pretrained_ckpt(osp.join(pretrained_dir, '9', 'ckpt'))
