...
def main_run(file_name, save_path, loop_num, csv_file):
    """
...
if __name__ == '__main__':
    ...
    file_name = 'gps_predict'
    save_path = '/home/lrx/dataset/cooperation/gps/results/'

    # 执行主函数
    main_run(file_name, save_path, loop_num, read_csv)
    print('----- all over -----')
