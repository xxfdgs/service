...
def compute_loss_l1_ntx_2(pred_1,true,gps_feature,pred_feature,batch,cur_epoch):
    ...
    for func in register.loss_dict.values():
        # value_l1 = l1_losses(pred_1, true_1)
        ...
        # loss_l1_scale_dynamic = torch.mean(torch.mul(value_l1, dy_weight), dtype=torch.float32)
        ...
        #                      region_losses(gps_feature, true_1, batch.y)))/2

        value = loss_l1_scale #+ loss_l1_similar
