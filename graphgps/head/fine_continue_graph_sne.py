...
@register_head('fine_continue_graph_sne') #feat_graph
class FineGraphHead(nn.Module):
    ...
    def _apply_index(self, batch):
        return batch.graph_feature, batch.y,batch.graph_feature_512

    #2023.05.16
    def forward(self, batch):
        graph_emb = self.pooling_fun(batch.x, batch.batch)
        # graph_emb_512 = graph_emb
        # batch.graph_feature_512 = graph_emb_512
        ...
        pred, label,sne = self._apply_index(batch)
        return pred, label,sne
