...
#
# Run:
#   bash scripts/pretrain/stage6/run_stage6a_ptd_difflr.sh
...
LABEL="${LABEL:-P1_PT_D_diffLR1e4}"

REST_LR="${REST_LR:-0.001}"
COMP5_LR="${COMP5_LR:-0.0001}"
...
echo
echo "Stage 6A screening completed."
